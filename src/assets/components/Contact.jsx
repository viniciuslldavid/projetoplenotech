    ...
    <section id="contato" className="py-16 bg-gray-100">
      <div className="container mx-auto px-4 text-center">
        ...
        <div className="mb-6">
          ...
          <p className="mb-2"><i className="fab fa-whatsapp mr-2"></i><a href="https://wa.me/5534999999999" target="_blank" rel="noopener noreferrer">Fale no WhatsApp</a></p>
          <p className="mb-2"><i className="fas fa-envelope mr-2"></i><a href="mailto:contato@plenotech.com.br">contato@plenotech.com.br</a></p>
        </div>
        <a href="https://wa.me/5534999999999" target="_blank" className="bg-green-600 text-white px-6 py-3 rounded-full font-semibold hover:bg-green-700">Entre em Contato</a>
      </div>
    </section>
  );
}
